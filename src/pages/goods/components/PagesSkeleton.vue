<template name="skeleton">
  <view class="sk-container">
    <scroll-view :scroll-y="true" class="viewport" :enable-back-to-top="true">
      <view class="goods">
        ...
        <view class="meta">
          ...
          <view class="name ellipsis sk-transparent sk-text-14-2857-515 sk-text"
            >梅乃宿梅酒720毫升</view
          >
          <view class="desc sk-transparent sk-text-0-0000-178 sk-text"
            >小藏手工酿造，百年名酒app</view
          >
        </view>
        <view class="action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-242 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-594 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-608 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-71 sk-text">
              请选择收获地址
            </text>
          </view>
    ...
    <view class="toolbar" style="padding-bottom: 0px">
      ...
      <view class="buttons">
        <view
          class="addcart sk-transparent sk-text-31-9444-444 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-31-9444-401 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
...
<style>
/*
此文件为开发者工具生成，生成时间: 2023/10/27下午7:25:42

在 /Users/yao/workspace-yyh/wx-project/heima-shop/dist/dev/mp-weixin/pages/goods/goods.wxss 中引入样式
```
