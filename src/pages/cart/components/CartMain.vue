...
<template>
  <scroll-view scroll-y class="scroll-view">
          ...
          <uni-swipe-action-item v-for="item in cartList" :key="item.skuId" class="cart-swipe">
            ...
            <template #right>
              <view class="cart-swipe-right">
                <button class="button delete-button" @tap="deletGoods(item.skuId)">删除</button>
              </view>
            </template>
    ...
    <!-- 猜你喜欢 -->
    <scroll-view scroll-y enable-back-to-top @scrolltolower="onScrolltolower">
